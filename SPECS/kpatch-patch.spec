...
%define kernel_ver	5.14.0-70.26.1.el9_0
...
%changelog
* Mon Oct 17 2022 Yannick Cote <ycote@redhat.com> [1-2.el9_0]
- kernel: posix cpu timer use-after-free may lead to local privilege escalation [2118959] {CVE-2022-2585}

* Tue Sep 06 2022 Yannick Cote <ycote@redhat.com> [0-0.el9]
- An empty patch to subscribe to kpatch stream for kernel-5.14.0-70.26.1.el9_0 [2124577]
